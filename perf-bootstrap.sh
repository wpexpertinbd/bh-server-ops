...
if   [ "$TARGET_RAM_GB" -ge 240 ]; then  # 256 GB-class (reports ~245-250)
  ...
  LIGHT_CHILDREN=24; HEAVY_CHILDREN=48
  ...
  LIGHT_CHILDREN=20; HEAVY_CHILDREN=40
  ...
  LIGHT_CHILDREN=16; HEAVY_CHILDREN=32
  ...
  LIGHT_CHILDREN=12; HEAVY_CHILDREN=24
  OPCACHE_MB=256;    OPCACHE_FILES=20000;   INTERNED_MB=16
  REDIS_MAX=1gb
  ...
  LIGHT_CHILDREN=7;  HEAVY_CHILDREN=14
